...
Para a distância frontal:
\[
\mu_{\text{Perto}}(10)=1,\qquad
\mu_{\text{Média}}(10)=0,\qquad
\mu_{\text{Longe}}(10)=0.
\]

Para a assimetria lateral:
\[
\mu_{\text{Negativa}}(-10)=\frac{0-(-10)}{25}=0{,}4,
\]
\[
\mu_{\text{Zero}}(-10)=\frac{-10-(-25)}{25}=0{,}6,
\qquad
\mu_{\text{Positiva}}(-10)=0.
\]
...
O universo de saída foi discretizado em passos de $5^\circ$.
...
Assim, $\sum\mu=8{,}4$ e $\sum\mu\theta=43$. Logo:
\[
\theta_{manual}=\frac{43}{8{,}4}=5{,}1190^\circ.
\]
...
\begin{center}
\small\nolinkurl{C:/Users/ferna/Desktop/01 - Faculdade/AUTOMACAO/fuzzy_robotica.sce}
\end{center}
