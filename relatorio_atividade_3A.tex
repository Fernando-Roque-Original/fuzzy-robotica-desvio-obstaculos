...
Os seis campos solicitados na atividade ficam, portanto, preenchidos por:
\[
\boxed{\mu_{\text{Perto}}(10)=1{,}0}\quad
\boxed{\mu_{\text{Média}}(10)=0{,}0}\quad
\boxed{\mu_{\text{Longe}}(10)=0{,}0}
\]
\[
\boxed{\mu_{\text{Negativa}}(-10)=0{,}4}\quad
\boxed{\mu_{\text{Zero}}(-10)=0{,}6}\quad
...
\begin{figure}[H]
  ...
  \caption{Fase 1 preenchida: valores crisp marcados e graus de pertinência.}
  \label{fig:fase1-anotada}
\end{figure}
...
A Figura~\ref{fig:fases34} reúne o que deve ser desenhado no gráfico em branco
das Fases 3 e 4: a contribuição da Regra 1 truncada em $0{,}4$, a contribuição
da Regra 2 truncada em $0{,}6$ e o contorno agregado obtido pelo máximo.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{06_fases3_4_implicacao_agregacao.png}
  \caption{Fases 3 e 4 preenchidas: implicação Mamdani e agregação.}
  \label{fig:fases34}
\end{figure}
...
\subsection*{Comparação entre o valor calculado e o valor simulado}

\begin{table}[H]
  \centering
  \caption{Comparação final exigida entre cálculo manual e simulação.}
  ...
  \begin{tabular}{>{\raggedright\arraybackslash}p{0.29\textwidth}
    ...
    \toprule
    \textbf{Resultado} & \textbf{Discretização} & \textbf{Ângulo $\theta$} & \textbf{Ação} \\
    \midrule
    Calculado manualmente pelo CDA & Passos de $5^\circ$ & $5{,}119048^\circ$ & Virar à direita \\
    Simulado no Scilab/sciFLT & 1001 pontos & $4{,}828622^\circ$ & Virar à direita \\
    Diferença (simulado $-$ manual) & -- & $-0{,}290426^\circ$ & Mesma decisão \\
    \bottomrule
  \end{tabular}
\end{table}

Portanto, o valor calculado manualmente é $5{,}119048^\circ$ e o valor
simulado é $4{,}828622^\circ$. Os dois resultados são positivos e levam à
mesma ação de controle: \textbf{virar para a direita}.
